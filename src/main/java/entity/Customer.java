...
public class Customer {
    ...
    private Employee employeeBySalesRepEmployeeNumber;
    private List<OrderEntity> orderEntityByCustomerNumber;
    private List<Payment> paymentByCustomerNumber;
    ...
    public Employee getEmployeesBySalesRepEmployeeNumber() {
        return employeeBySalesRepEmployeeNumber;
    }

    public void setEmployeesBySalesRepEmployeeNumber(Employee employeeBySalesRepEmployeeNumber) {
        this.employeeBySalesRepEmployeeNumber = employeeBySalesRepEmployeeNumber;
    }

    @OneToMany(mappedBy = "customersByCustomerNumber")
    public List<OrderEntity> getOrdersByCustomerNumber() {
        return orderEntityByCustomerNumber;
    }

    public void setOrdersByCustomerNumber(List<OrderEntity> orderEntityByCustomerNumber) {
        this.orderEntityByCustomerNumber = orderEntityByCustomerNumber;
    }

    @OneToMany(mappedBy = "customersByCustomerNumber")
    public List<Payment> getPaymentsByCustomerNumber() {
        return paymentByCustomerNumber;
    }

    public void setPaymentsByCustomerNumber(List<Payment> paymentByCustomerNumber) {
        this.paymentByCustomerNumber = paymentByCustomerNumber;
    }
}
