...
public class Office {
    ...
    private List<Employee> employeeByOfficeCode;
    ...
    public List<Employee> getEmployeesByOfficeCode() {
        return employeeByOfficeCode;
    }

    public void setEmployeesByOfficeCode(List<Employee> employeeByOfficeCode) {
        this.employeeByOfficeCode = employeeByOfficeCode;
    }
}
